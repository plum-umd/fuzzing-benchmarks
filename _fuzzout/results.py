...
subdirs = ["empty_seed", "magic_seed", "samp_seeds_16", "samp_seeds_9", "samp_seeds_3", "samp_seeds_1", "hello_seeds_3", "hello_seeds_1", "rand_seeds_3", "rand_seeds_1", "other_seeds_1"]
...
def cmp_empty(prog, seeds):
    cmps = [x + "_" + prog for x in seeds]
    for cmp in cmps:
        print(compare_prog("empty_seed_" + prog, "afl", cmp, "afl"))
        print(compare_prog("empty_seed_" + prog, "aflfast", cmp, "aflfast"))

#cmp_empty("FFmpeg", ["samp_seeds_9", "samp_seeds_3", "samp_seeds_1"])
cmp_empty("nm", ["samp_seeds_16", "samp_seeds_3", "samp_seeds_1", "hello_seeds_3", "hello_seeds_1"])
